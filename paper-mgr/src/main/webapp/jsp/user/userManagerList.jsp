            ...
            <div class="wp-content_right thirteen wide column">
                <div class="ui basic segment">
                    ...
                    <div class="ui breadcrumb">
                        ...
                        <div class="section active">用户列表</div>
                    </div>
                    <!--面包屑 end-->
                </div>
                <div class="ui basic segment">
                    ...
                    <div class="ui secondary menu">
                        <div class="fitted item">
                            <button class="ui blue button" onclick="addUser();"><i class="add icon"></i> 添加用户</button>
                        </div>
                        <!--查询-->
                        <div class="fitted item">
                            <div class="ui icon input">
                                <input type="text" placeholder="用户账号模糊搜索" id="searchAccount">
                                <i class="search link icon" onclick="search();"></i>
                            </div>
                        </div>
                        <div class="fitted item">
                            <div class="ui icon input">
                                <input type="text" placeholder="用户名称模糊搜索" id="searchTitle">
                                <i class="search link icon" onclick="search();"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ui basic segment">
                    ...
                    <table class="ui very basic very compact unstackable table center aligned">
                        ...
                        <thead>
                        <tr>
                            <th class="two wide">用户账号</th>
                            <th class="two wide">用户名称</th>
                            <th class="two wide">联系方式</th>
                            <th class="five wide">用户描述</th>
                            <th class="two wide">添加时间</th>
...
<script type="text/javascript" src="<%=basePath %>/js/mgr/user/userList.js"></script>
<!--注意：开发时删除 end-->

<!--脚部 end-->

<!--删除 & 相关提示 start-->
<div class="ui tiny modal delete" id="user_delete" style="height: 200px;">
    <div class="header">
        删除用户
    </div>
    <div class="content">
