            ...
            <div class="wp-content_right thirteen wide column">
                <div class="ui basic segment">
                    ...
                    <div class="ui breadcrumb">
                        ...
                        <div class="section active">修改用户</div>
                    </div>
                    <!--面包屑 end-->
                </div>
                <div class="ui basic segment">
                    ...
                    <div class="ui form sc-form">
                        ...
                        <div class="required fields">
                            ...
                            <div class="three wide field">
                                <input name="account" id="account" type="text" value="" placeholder="请输入登录账号，不超过45个字">
                            </div>
                        </div>
                        <div class="required fields">
                            <div class="two wide field">
                        ...
                        <div class="required fields">
                            ...
                            <div class="three wide field">
                                <input name="name" id="name" type="text" value="" placeholder="请输入姓名，不超过45个字">
                            </div>
                        </div>
                        <div class="required fields">
                            <div class="two wide field">
