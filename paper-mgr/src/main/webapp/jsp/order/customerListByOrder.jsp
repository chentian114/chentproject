            ...
            <div class="wp-content_right thirteen wide column">
                <div class="ui basic segment">
                    ...
                    <div class="ui breadcrumb">
                        ...
                        <div class="section active">客户列表</div>
                    </div>
                    <!--面包屑 end-->
                </div>
                <div class="ui basic segment">
                    ...
                    <div class="ui secondary menu">
                        <div class="fitted item">
                            <button class="ui blue button" onclick="addCustomer();"><i class="add icon"></i> 添加客户</button>
                        </div>
                        <!--查询-->
                        <div class="fitted item">
                        ...
                        <div class="fitted item">
                            <div class="ui icon input">
                                <input type="text" placeholder="客户地址模糊搜索" id="searchAddress">
                                <i class="search link icon" onclick="search();"></i>
                            </div>
                        </div>
                        <div class="fitted item">
                ...
                <div class="ui basic segment">
                    ...
                    <table class="ui very basic very compact unstackable table center aligned">
                        ...
                        <tr>
                            ...
                            <th class="five wide">客户地址</th>
                            <th class="two wide">联系电话</th>
                            <th class="two wide">类别</th>
                            <th class="two wide">所属业务员</th>
...
<script type="text/javascript" src="<%=basePath %>/js/mgr/order/customerListByOrder.js"></script>
<!--注意：开发时删除 end-->
