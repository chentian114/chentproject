            ...
            <div class="wp-content_right thirteen wide column">
                <div class="ui basic segment">
                    ...
                    <div class="ui breadcrumb">
                        ...
                        <div class="section active">业务员详情</div>
                    </div>
                    <!--面包屑 end-->
                </div>
                <div class="ui basic segment">
...
<script type="text/javascript" src="<%=basePath %>/js/mgr/order/salesmanDetails.js"></script>
