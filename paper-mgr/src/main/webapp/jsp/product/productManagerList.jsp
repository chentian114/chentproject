      ...
      <div class="wp-content_right thirteen wide column">
        <div class="ui basic segment">
          ...
          <div class="ui breadcrumb">
            ...
            <div class="section active">产品列表</div>
          </div>
          <!--面包屑 end-->
        </div>
        <div class="ui basic segment">
          ...
          <div class="ui secondary menu">
            <div class="fitted item">
              <button class="ui blue button" onclick="addProduct();"><i class="add icon"></i> 添加产品</button>
            </div>
            <!--查询-->
            <div class="fitted item">
              <div class="ui icon input">
                <input type="text" placeholder="产品名称模糊搜索" id="searchTitle">
        ...
        <div class="ui basic segment">
          ...
          <table class="ui very basic very compact unstackable table center aligned">
            ...
            <thead>
            <tr>
              <th class="two wide">产品名称</th>
              <th class="five wide">产品描述</th>
...
<script type="text/javascript" src="<%=basePath %>/js/mgr/product/productList.js"></script>
<!--注意：开发时删除 end-->
...
<!--删除 & 相关提示 start-->
<!--删除新闻-->
<div class="ui tiny modal delete" id="product_delete" style="height: 200px;">
  <div class="header">
    删除产品
  </div>
  <div class="content">
